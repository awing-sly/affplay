...
#define FFMPEG_CONFIGURATION "--prefix=/home/awing/myworkspaces/ffmpegspaces/ffmpeg-4.1.3/android/armeabi-v7a --disable-everything --disable-programs --disable-doc --disable-ffprobe --disable-ffplay --disable-ffmpeg --enable-jni --enable-encoder=aac --enable-encoder=mpeg4 --enable-encoder=pcm_u16le --enable-encoder=pcm_s16le --enable-encoder=yuv4 --enable-encoder=rawvideo --enable-encoder=wrapped_avframe --enable-decoder=aac --enable-decoder=aac_at --enable-decoder=aac_fixed --enable-decoder=aac_latm --enable-decoder=ac3 --enable-decoder=ac3_at --enable-decoder=ac3_fixed --enable-decoder=avs --enable-decoder=eac3 --enable-decoder=eac3_at --enable-decoder=h263 --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=mp1 --enable-decoder=mp1_at --enable-decoder=mp1float --enable-decoder=mp2 --enable-decoder=mp2_at --enable-decoder=mp2float --enable-decoder=mp3 --enable-decoder=mp3_at --enable-decoder=mp3float --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder=mpeg1video --enable-decoder=mpeg2video --enable-decoder=mpeg4 --enable-decoder=mpegvideo --enable-decoder=pcm_u16le --enable-decoder=pcm_s16le --enable-decoder=yuv4 --enable-decoder=rawvideo --enable-decoder=wrapped_avframe --enable-muxer=mpegts --enable-muxer=mp4 --enable-muxer=matroska --enable-muxer=matroska_audio --enable-muxer=webm --enable-muxer=h264 --enable-muxer=hevc --enable-muxer=rawvideo --enable-muxer=adts --enable-muxer=yuv4mpegpipe --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=eac3 --enable-demuxer=m4v --enable-demuxer=matroska --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=h263 --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=mov --enable-demuxer=rawvideo --enable-demuxer=yuv4mpegpipe --enable-parser=aac --enable-parser=aac_latm --enable-parser=ac3 --enable-parser=h263 --enable-parser=h264 --enable-parser=hevc --enable-parser=mpeg4video --enable-parser=mpegaudio --enable-parser=mpegvideo --enable-parser=vp8 --enable-parser=vp9 --enable-protocol=file --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-bsf=hevc_mp4toannexb --enable-bsf=mpeg4_unpack_bframes --enable-filter=scale --enable-gpl --enable-shared --disable-static --enable-small --disable-zlib --disable-xlib --disable-iconv --disable-alsa --disable-libxcb_shape --disable-libxcb_xfixes --disable-lzma --disable-sdl2 --disable-sndio --disable-bzlib --disable-libxcb --disable-hwaccels --disable-stripping --target-os=android --enable-cross-compile --toolchain=clang-usan --cross-prefix=/home/awing/myworkspaces/ffmpegspaces/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --cc=/home/awing/myworkspaces/ffmpegspaces/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi16-clang --cxx=/home/awing/myworkspaces/ffmpegspaces/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi16-clang++ --extra-cflags='-Os -fpic ' --extra-ldflags='-Wl,-Bsymbolic' --sysroot=/home/awing/myworkspaces/ffmpegspaces/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/sysroot --arch=arm"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/home/awing/myworkspaces/ffmpegspaces/ffmpeg-4.1.3/android/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/home/awing/myworkspaces/ffmpegspaces/ffmpeg-4.1.3/android/armeabi-v7a/share/ffmpeg"
